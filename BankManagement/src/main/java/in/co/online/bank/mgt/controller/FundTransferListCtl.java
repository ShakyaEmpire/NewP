...
/**
 * Servlet implementation class FundTransferListCtl
 */
@WebServlet(name = "FundTransferListCtl", urlPatterns = { "/ctl/FundTransferListCtl" })
public class FundTransferListCtl extends BaseCtl {
	private static final long serialVersionUID = 1L;
       
	private static Logger log = Logger.getLogger(FundTransferListCtl.class);
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("FundTransferListCtl populateBean method start");
		FundTransferBean bean = new FundTransferBean();
		bean.setByAccountNo(DataUtility.getLong(request.getParameter("byAccount")));
		bean.setBenAccountNo(DataUtility.getLong(request.getParameter("benAccount")));
		log.debug("FundTransferListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("FundTransferListCtl doGet method start");
		List list = null;
		int pageNo = 1;
		...
		log.debug("FundTransferListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("FundTransferListCtl doPost method start");
		List list = null;
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				FundTransferBean deletebean = new FundTransferBean();
				for (String id : ids) {
		...
		log.debug("FundTransferListCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return OBMView.FUND_TRANSFER_LIST_VIEW;
	}
