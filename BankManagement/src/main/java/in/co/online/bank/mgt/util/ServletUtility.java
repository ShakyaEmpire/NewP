...
import in.co.online.bank.mgt.controller.BaseCtl;
import in.co.online.bank.mgt.controller.OBMView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OBMView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
