...
/**
 * Servlet implementation class BankListCtl
 */
...
public class BankListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("BankListCtl populateBean method start");
		BankBean bean = new BankBean();
		bean.setName(DataUtility.getString(request.getParameter("name")));
		bean.setShortCode(DataUtility.getString(request.getParameter("sCode")));
		log.debug("BankListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("BankListCtl doGet method start");
		List list = null;
		int pageNo = 1;
		...
		log.debug("BankListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("BankListCtl doPost method start");
		List list = null;
		...
		log.debug("BankListCtl doPost method end");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return OBMView.BANK_LIST_VIEW;
	}
