<%@page import="in.co.online.bank.mgt.controller.UserRegistrationCtl"%>
    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <form method="post" action="<%=OBMView.USER_REGISTRATION_CTL%>">
                      ...
                      <p>Bank Detail</p>
                       ...
                       <hr>
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="controls col-md-8 ">
                                <input type="submit" name="operation" value="<%=UserRegistrationCtl.OP_SAVE%>" class="btn btn-primary btn btn-info"  />
                                or <input type="submit" name="operation" value="<%=UserRegistrationCtl.OP_RESET %>" class="btn btn btn-primary"  />
                            </div>
                        </div> 
