    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
                <form method="post" action="<%=OBMView.LOGIN_CTL%>">
		...
		<% String uri=(String)request.getAttribute("uri");%>
              ...
              <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="controls col-md-8 ">
                                 <input type="submit" name="operation" value="<%=LoginCtl.OP_SIGN_IN%>" class="btn btn-primary btn btn-info"  />  or <input type="submit" name="operation" value="<%=LoginCtl.OP_SIGN_UP%>" class="btn btn btn-primary"  />
                            </div>
                        </div> 
